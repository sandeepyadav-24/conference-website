    ...
    <div className="select-none">
      ...
      <div className="col-span-1 flex flex-col items-center gap-2 justify-center my-5">
        <div>
          <a
            href=""
            className="inline-flex items-center justify-center px-5 py-2 mr-3 text-base font-medium text-center text-white rounded-lg bg-sky-600 hover:bg-sky-700 shrink-on-hover focus:ring-4 focus:ring-sky-300 no-underline dark:focus:ring-sky-700"
          >
            View all
          </a>
        </div>
